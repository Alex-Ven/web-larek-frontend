...
- setOrderField(field: keyof IDeliveryForm, value: string) - установка данных способо оплаты и адресса при успешной валидации
- setContactField(field: keyof IOrderForm, value: string) - установка данных контактов при успешной валидации
